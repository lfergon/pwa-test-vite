<template>
  <div class="content">
    ...
    <button class="button is-primary is-loading" v-if="loading">Loading...</button>
    <div class="notification is-danger" v-else-if="error">Error: {{ error.message }}</div>
    <div v-else-if="teas">
      <div class="columns is-multiline is-mobile">
        <div class="column is-one-third" v-for="tea of teas" :key="tea.id">
          <CardTea :name="tea.name" :description="tea.description" :price="tea.price"/>
        </div>
      </div>
    </div>
  </div>
